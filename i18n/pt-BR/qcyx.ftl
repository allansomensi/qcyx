...
home-action-check-update = Verificar atualização
...
settings-doubletap-toggle-label = Toque duplo para pausar
settings-doubletap-toggle-desc = Controla a reprodução com toques no fone.
settings-voice-prompts-toggle-label = Avisos de voz
settings-voice-prompts-toggle-desc = Anuncia conexão, bateria e modo de ANC.
