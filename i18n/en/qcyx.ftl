...
home-action-check-update = Check for updates
...
settings-doubletap-toggle-label = Double-tap to pause
settings-doubletap-toggle-desc = Control playback with earbud taps.
settings-voice-prompts-toggle-label = Voice prompts
settings-voice-prompts-toggle-desc = Announces connection, battery and ANC mode.
